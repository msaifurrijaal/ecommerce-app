...
import com.msaifurrijaal.tokoonline.data.model.auth.RegisterRequest
...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun onAction() {
        binding.btnRegister.setOnClickListener {
            ...
            if (checkValid(name, email, phone, pass, confirmPass)) {
                registerToServe(name, email, phone, pass)
            }
    ...
    private fun registerToServe(name: String, email: String, phone: String, pass: String) {
    ...
    private fun checkValid(
        ...
        return when {
            ...
            pass != confirmPass -> {
                ...
                binding.textInputPasswordRegister.requestFocus()
                binding.textInputConfirmPasswordRegister.error =
                    getString(R.string.field_didnt_match)
                binding.textInputConfirmPasswordRegister.requestFocus()
